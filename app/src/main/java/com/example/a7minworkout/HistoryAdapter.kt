...
class HistoryAdapter(val context: Context, val items:ArrayList<String>):
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        val tvItem= view.findViewById<TextView>(R.id.tvItemHistory)
        val tvPosition = view.findViewById<TextView>(R.id.tvPositionHistory)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(context).inflate(R.layout.item_histroy_row, parent, false)
        )
    }
